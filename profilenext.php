...
<body>
<div id='srt' style='width:100%;height:30px;background:blue'></div>
<button  style='background:#33cccc;border-radius:10%;text-align:center;font-family:cursive;font-size:18px;color:white;width:70px;padding:5px;position:absolute;top:70px;left:30px;text-align:center;height:43px;width:89px;' onclick='g()' >home</button>
<div style='font-family:cursive;font-size:18px;letter-spacing:2px;color:rgba(0,112,0,0.7);width:60%;position:absolute;top:130px;right:170px;box-shadow:5px 5px 5px lightblue;'> 
...
<div style='position:relative;top:10px;left:300px;background:rgba(0,112,0,0.7);padding:15px;width:600px;height:550px;border-radius:6%;box-shadow:5px 5px 5px lightblue;'>
<form action='' method='post'>
